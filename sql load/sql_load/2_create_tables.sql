...
ALTER TABLE public.company_dim OWNER to amit;
ALTER TABLE public.skills_dim OWNER to amit;
ALTER TABLE public.job_postings_fact OWNER to amit;
ALTER TABLE public.skills_job_dim OWNER to amit;
