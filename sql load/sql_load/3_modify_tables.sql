...
COPY company_dim
FROM 'D:\data analyst\data course\targilim\python\csv_files-advenced part\csv_files\company_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY skills_dim
FROM 'D:\data analyst\data course\targilim\python\csv_files-advenced part\csv_files\skills_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY job_postings_fact
FROM 'D:\data analyst\data course\targilim\python\csv_files-advenced part\csv_files\job_postings_fact.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY skills_job_dim
FROM 'D:\data analyst\data course\targilim\python\csv_files-advenced part\csv_files\skills_job_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

SELECT  '2066-01-19'::DATE;